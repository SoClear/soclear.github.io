...
考研中考过：当 $\displaystyle n\pi<x<\left(n+1\right)\pi,2n<S\left(x\right)<2\left(n+1\right)$ 时，$\displaystyle\frac{2n}{\left(n+1\right)\pi}<\frac{S\left(x\right)}{r}<\frac{2\left(n+1\right)}{n\pi}$
