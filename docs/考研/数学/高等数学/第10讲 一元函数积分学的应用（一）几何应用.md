...
【注】 ${\int }_{0}^{\pi }\pi {\mathrm{e}}^{-x}\sin x\mathrm{\;d}x = {\left. \frac{\pi }{2}\left( \begin{matrix} {\mathrm{e}}^{-x} & \\ {\mathrm{e}}^{-x} & \sin x \end{matrix}\right) {\left. \right| }_{0}^{\pi } = - \frac{\pi }{2}\left( \cos x + \sin x\right) {\mathrm{e}}^{-x}\right| }_{0}^{\pi } = \frac{\pi }{2}\left( {{\mathrm{e}}^{-\pi } + 1}\right)$ .
