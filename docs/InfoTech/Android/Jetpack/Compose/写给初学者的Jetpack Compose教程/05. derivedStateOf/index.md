...
书接上篇的Compose文章，[写给初学者的Jetpack Compose教程，Lazy Layout](../04.%20Lazy%20Layout/index.md)。
...
简单来说，重组就是通过刷新界面来让Compose中显示的内容进行更新。那么如何刷新界面呢，这就要借助State来实现了。我在 [写给初学者的Jetpack Compose教程，使用State让界面动起来](../03.%20State/index.md) 这篇文章中有详细介绍State的用法。
